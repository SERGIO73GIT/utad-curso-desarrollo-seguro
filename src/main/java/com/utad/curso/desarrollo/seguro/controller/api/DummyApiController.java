...
import com.utad.curso.desarrollo.seguro.dto.DummyRequestSubAttribute;
...
public class DummyApiController {
    ...
    public DummyResponseDto get(
            @RequestParam(name = "param1", required = false, defaultValue = "value") @Email @NotBlank String param1,
    ...
    public DummyResponseDto post(
        ...
        List<String> attribute4 = body.getAttribute4();
        for (String str : attribute4) {
            logger.info(str);
        }

        for (DummyRequestSubAttribute subAttribute : body.getAttribute5()) {
